      		...
      		<div class="col-12">
      			<div class="card">
      				...
      				<div class="card-content collapse show">
                        ...
                        <form class="" action="<?php echo base_url('panel/task/updateRequestTask/do_update/'.my_simple_crypt($key->id_tasklist,'e'));?>" method="post">
                            <div class="form-group">
                            <label class="col-md-2 control-label" for="nama_pekerjaan">Nama Pekerjaan</label>
                                <div class="col-md-10">
                                    <input type="text" id="nama_pekerjaan" name="nama_pekerjaan" class="form-control border-primary" value="<?php echo $key->nama_pekerjaan?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                              <select class="form-control border-primary" name="jenis_pekerjaan" required>
                                <option value="<?php echo $key->jenis_pekerjaan?>"><?php echo $key->jenis_pekerjaan?></option>
                            ...
                            <label class="col-md-2 control-label" for="detail_pekerjaan">Detail Pekerjaan</label>
                                <div class="col-md-10">
                                    <textarea name="detail_pekerjaan" class="form-control border-primary" id='detail_pekerjaan'><?php echo $key->detail_pekerjaan?></textarea>
                                </div>
                            </div>
                            ...
                            <label class="col-md-2 control-label" for="start_date">Waktu Mulai</label>
                                <div class="col-md-10">
                                    <input type="date" id="start_date" name="start_date" class="form-control border-primary" value="<?php echo $key->start_date?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <label class="col-md-4 control-label" for="keterangan_pekerjaan">Keterangan Pekerjaan</label>
                                <div class="col-md-10">
                                    <textarea name="keterangan_pekerjaan" class="form-control border-primary"><?php echo $key->keterangan_pekerjaan?></textarea>
                                </div>
                            </div>
